...
# Build a new tree with Random Forest in our new features
...
Prediction7th <- predict(object = fit2, newdata = test, OOB=TRUE, type = "response")

Prediction7 <- data.frame(PassengerId = test$PassengerId, Survived = Prediction7th)

write.csv(Prediction7, file = "7thprediction.csv", row.names = FALSE)
